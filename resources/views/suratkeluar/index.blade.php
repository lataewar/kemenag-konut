...
<x-subheader title="Surat Keluar" route="suratkeluar.index">
  <div class="default-btns">
    ...
    <x-btn.a-weight-bold-svg svg="Files/DownloadedFile.svg" href="{{ route('suratkeluar.cetak') }}" class="btn-success mr-2 btn-report">
...
<script>
  ...
  const columnDefs = [
    { targets: [0, 1, 7], orderable: false, className: 'text-center align-top font-size-xs' },
    { targets: [2, 3, 4, 5], orderable: true, className: 'align-top font-size-xs' },
    { targets: [6], orderable: true, className: 'text-center align-top font-size-xs' },
  ];
