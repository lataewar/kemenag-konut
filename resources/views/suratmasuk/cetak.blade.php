...
@section('subheader')
  <x-subheader title="Surat Masuk" route="suratmasuk.index">
    @slot('breadcrumb')
      <x-bc.item route="#">Cetak Surat Masuk</x-bc.item>
    @endslot
    <div class="default-btns">
      <x-btn.a-weight-bold-svg svg="Navigation/Angle-left.svg" href="{{ route('suratmasuk.index') }}"
...
@section('content')
  <!--begin::Card-->
  <form action="{{ route('suratmasuk.postcetak') }}" class="row" method="POST">
    @csrf
    <div class="col-md-12">
