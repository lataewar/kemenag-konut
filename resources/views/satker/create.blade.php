<form action="{{ route('satker.store') }}" class="row createform" id="createform" method="POST"> @csrf
  <div class="col-md-12">
      ...
      <div class="card-body p-0">
        <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
          <div class="col-xl-12 col-xxl-9">
            ...
            <x-validation.inline.txt type="text" name="kode" id="kode" placeholder="Kode Satuan Kerja"
              value="{{ $data->kode ?? '' }}">
