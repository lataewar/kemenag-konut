...
$(document).ready(function () {
  ...
  $('#status_').fadeOut();
  $('#preloader_').delay(350).fadeOut('slow');
});
  ...
  $.fn[pluginName] = function (options) {
    ...
    var Plugin = {
      ...
      dropdownFix: function () {
        var dropdownMenu;
        $('body')
          .on('show.bs.dropdown', '.' + pfx + 'datatable .' + pfx + 'datatable-body', function (e) {
            dropdownMenu = $(e.target).find('.dropdown-menu');
            $('body').append(dropdownMenu.detach());
            // dropdownMenu.css('display', 'block');
            dropdownMenu.position({
          ...
          addPaginateEvent: function (e) {
            ...
            $(datatable)
              ...
              .on(pg.paginateEvent, function (e, meta) {
                ...
                $(pagerNumber)
                  .find('.' + pfx + 'datatable-pager-link-number[data-page="' + meta.page + '"]')
          ...
          $(datatable.tableBody).each(function () {
            ...
            while (offsetWidth < scrollWidth && scrollWidth - offsetWidth > Plugin.cellOffset && recursive < options.columns.length) {
              $(datatable.table)
                ...
                .each(function (i) {
                  var cell = $(this)
                    .find('.' + pfx + 'datatable-cell:not(:hidden):not([data-autohide-disabled])')
                    .last();
                  if (cell.length) {
                    $(cell).hide();
                    hiddenExist = true;
        ...
        var sortObj = {
          ...
          setIcon: function () {
            ...
            var td = $(datatable.tableHead)
              .find('.' + pfx + 'datatable-cell[data-field="' + meta.field + '"]')
      ...
      rowEvenOdd: function () {
        ...
        if ($(datatable.wrap).hasClass(pfx + 'datatable-subtable')) {
          $(datatable.tableBody)
            .find('.' + pfx + 'datatable-row:not(.' + pfx + 'datatable-row-detail):even')
      ...
      rows: function (selector) {
        if (Plugin.isLocked()) {
          Plugin.nodeTr = Plugin.recentNode = $(datatable.tableBody)
            .find(selector)
            .filter('.' + pfx + 'datatable-lock-scroll > .' + pfx + 'datatable-row');
        } else {
          Plugin.nodeTr = Plugin.recentNode = $(datatable.tableBody)
            .find(selector)
